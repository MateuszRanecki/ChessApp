...
namespace Chess_App
{
    internal static class PositionEvaluation
    {
        ...
        private static int EvaluatePieceScore(VariableSquare square, byte position, bool endGamePhase,
        ...
        private static int CheckPawnWall(ChessBoard board, int pawnPos, int kingPos)
        {
