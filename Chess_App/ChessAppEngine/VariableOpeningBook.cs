...
namespace Chess_App
{
    internal class VariableOpeningBook
    {
        ...
        internal static List<OpeningMove> PopulateOpeningBook()
        {
            ...
            {
                openingMove.Moves.Add(new ChessMove(m));
            }
            openingMove = new OpeningMove();
        ...
        internal static int ValidateOpeningBook(List<OpeningMove> openingBook)
        {
            ...
            {
                foreach (ChessMove move in moves.Moves)
                {
                    if (!IsValidMove(move.MovingPiecePrimary.SourcePosition, move.MovingPiecePrimary.DestinatedPosition, moves.StartingFEN))
                    {
                        failed++;
                    }
                }
